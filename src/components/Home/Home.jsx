...
const Home = () => {
  const STATS = [
          ...
          { top: "People Visited Website", value: 19, bottom: "in "+new Date().toLocaleString("en-US", { month: "long" }) },
          { top: "People Visited Website", value: 48, bottom: "in "+new Date().getFullYear() },
        ];
