...
const Home = () => {
  const STATS = [
          ...
          { top: "People Visited Website", value: 16, bottom: "in "+new Date().toLocaleString("en-US", { month: "long" }) },
          { top: "People Visited Website", value: 46, bottom: "in "+new Date().getFullYear() },
        ];
